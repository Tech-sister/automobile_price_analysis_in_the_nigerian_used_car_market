...
def display_metrics(filtered_df):
    ...
    with col2:
        ...
        st.metric("💲Average Price", f"₦{avg_price_m:,.2f}M")
...
def main():
    ...
    The analysis shows that Toyota, Lexus, and Mercedes-Benz dominate the Nigerian used-car market both in listing frequency and average selling price. 
    
    Foreign Used vehicles consistently command higher prices than Local Used vehicles, indicating stronger customer preference and perceived quality.
                    
    Newer vehicle models show a positive correlation with price, meaning vehicle age is a major pricing factor.
                        
    Automatic transmission vehicles appear more frequently and generally sell at higher prices than manual vehicles.
                        
    Toyota Hilux and Lexus RX 350 retain value better than Honda Accord, making them strong-performing models.
                        
    Dealers should increase inventory of high-demand Foreign Used vehicles while improving marketing strategies for lower-performing brands and older models.
                        
    Focus should also be placed on newer automatic vehicles, which represent the most profitable segment of the market.
    """)
